...
## Booting the Library
```lua
local Rayfield = loadstring(game:HttpGet("https://raw.githubusercontent.com/SentinalCoder/SentinalWare/main/main/source"))()
```
...
local Window = Rayfield:CreateWindow({
	Name = "SentinalWare Example Window",
	LoadingTitle = "Sentinal Interface Suite",
	LoadingSubtitle = "by Sentinal",
	ConfigurationSaving = {
		Enabled = true,
